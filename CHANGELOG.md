...
- Add searchable, classified Browse Orgs list with Setup and private-window actions.
- Add automatic Salesforce CLI discovery, including common Node version managers and an explicit path preference.
